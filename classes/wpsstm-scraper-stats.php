...
class WPSSTM_Live_Playlist_Stats{ //TO FIX TO UPGRADE
    ...
    function set_request_count(){
        ...
        if ( $success = update_post_meta($post_id, self::$meta_key_requests, $count) ){
            $this->tracklist->tracklist_log($count,"WPSSTM_Live_Playlist_Stats::set_request_count()"); 
            return $success;
        }
    ...
    function set_monthly_request_count(){
        ...
        if ( $success = update_post_meta($post_id, self::$meta_key_monthly_requests, $count ) ){
            $this->tracklist->tracklist_log($count,"WPSSTM_Live_Playlist_Stats::set_monthly_request_count()"); 
            return $success;
        }
    ...
    function set_health(){
        ...
        $this->tracklist->tracklist_log($log_success_pc,"WPSSTM_Live_Playlist_Stats::set_health()"); 
